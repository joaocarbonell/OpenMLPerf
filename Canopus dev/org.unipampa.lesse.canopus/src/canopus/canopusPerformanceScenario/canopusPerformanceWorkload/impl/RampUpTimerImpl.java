 ...
 * </p>
 * <ul>
 *   <li>{@link canopus.canopusPerformanceScenario.canopusPerformanceWorkload.impl.RampUpTimerImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RampUpTimerImpl extends MinimalEObjectImpl.Container implements RampUpTimer {
	...
	protected EClass eStaticClass() {
		return CanopusPerformanceWorkloadPackage.Literals.RAMP_UP_TIMER;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanopusPerformanceWorkloadPackage.RAMP_UP_TIMER__TIME, oldTime, time));
	}
