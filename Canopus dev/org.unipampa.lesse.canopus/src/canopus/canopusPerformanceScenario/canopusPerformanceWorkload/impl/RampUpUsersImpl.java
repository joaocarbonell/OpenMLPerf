...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ramp Up Users</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link canopus.canopusPerformanceScenario.canopusPerformanceWorkload.impl.RampUpUsersImpl#getVirtualUsers <em>Virtual Users</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RampUpUsersImpl extends MinimalEObjectImpl.Container implements RampUpUsers {
	/**
	...
	protected EClass eStaticClass() {
		return CanopusPerformanceWorkloadPackage.Literals.RAMP_UP_USERS;
	}
	...
	public void setVirtualUsers(int newVirtualUsers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanopusPerformanceWorkloadPackage.RAMP_UP_USERS__VIRTUAL_USERS, oldVirtualUsers, virtualUsers));
	}
