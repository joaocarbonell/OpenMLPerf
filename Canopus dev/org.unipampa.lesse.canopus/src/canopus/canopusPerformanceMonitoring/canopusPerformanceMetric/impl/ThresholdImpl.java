 ...
 * </p>
 * <ul>
 *   <li>{@link canopus.canopusPerformanceMonitoring.canopusPerformanceMetric.impl.ThresholdImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ThresholdImpl extends MinimalEObjectImpl.Container implements Threshold {
	...
	protected EClass eStaticClass() {
		return CanopusPerformanceMetricPackage.Literals.THRESHOLD;
	}
	...
	public void setValue(int newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanopusPerformanceMetricPackage.THRESHOLD__VALUE, oldValue, value));
	}
