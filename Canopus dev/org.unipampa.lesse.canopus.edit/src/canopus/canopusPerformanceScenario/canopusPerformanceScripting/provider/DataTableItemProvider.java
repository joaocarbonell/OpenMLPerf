...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceScenario.canopusPerformanceScripting.DataTable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataTableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CanopusPerformanceScriptingPackage.Literals.DATA_TABLE__DELIMETER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CanopusPerformanceScriptingPackage.Literals.DATA_TABLE__ACTIVITY,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CanopusPerformanceScriptingPackage.Literals.DATA_TABLE__COLUMNSHIDDENOBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CanopusPerformanceScriptingPackage.Literals.DATA_TABLE__COLUMNSHIDDENOBJECT,
