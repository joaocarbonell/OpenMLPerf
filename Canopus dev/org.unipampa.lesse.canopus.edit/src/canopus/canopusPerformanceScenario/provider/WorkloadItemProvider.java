...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceScenario.Workload} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkloadItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CanopusPerformanceScenarioPackage.Literals.WORKLOAD__NAME,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CanopusPerformanceScenarioPackage.Literals.WORKLOAD__RAMP_DOWN_USERS,
				 CanopusPerformanceWorkloadFactory.eINSTANCE.createRampDownUsers()));

		newChildDescriptors.add
			(createChildParameter
				(CanopusPerformanceScenarioPackage.Literals.WORKLOAD__RAMP_UP_USERS,
