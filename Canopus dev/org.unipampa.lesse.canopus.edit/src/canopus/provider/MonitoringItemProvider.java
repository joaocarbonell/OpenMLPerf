...
/**
 * This is the item provider adapter for a {@link canopus.Monitoring} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitoringItemProvider extends DiagramItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CanopusPackage.Literals.MONITORING__SUTS);
			childrenFeatures.add(CanopusPackage.Literals.MONITORING__LOAD_GENERATORS);
			childrenFeatures.add(CanopusPackage.Literals.MONITORING__MONITORS);
			childrenFeatures.add(CanopusPackage.Literals.MONITORING__METRIC_MODEL);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CanopusPackage.Literals.MONITORING__SUTS,
				 CanopusPerformanceMonitoringFactory.eINSTANCE.createSUT()));

		newChildDescriptors.add
			(createChildParameter
				(CanopusPackage.Literals.MONITORING__LOAD_GENERATORS,
				 CanopusPerformanceMonitoringFactory.eINSTANCE.createLoadGenerator()));

		newChildDescriptors.add
			(createChildParameter
				(CanopusPackage.Literals.MONITORING__MONITORS,
				 CanopusPerformanceMonitoringFactory.eINSTANCE.createMonitor()));

		newChildDescriptors.add
			(createChildParameter
				(CanopusPackage.Literals.MONITORING__METRIC_MODEL,
