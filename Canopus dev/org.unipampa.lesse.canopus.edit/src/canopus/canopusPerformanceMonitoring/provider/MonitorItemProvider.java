...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceMonitoring.Monitor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MonitorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_hostname_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_hostname_feature", "_UI_Monitor_type"),
				 CanopusPerformanceMonitoringPackage.Literals.MONITOR__HOSTNAME,
				 true,
				 false,
				 false,
	...
	protected void addIpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_ip_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_ip_feature", "_UI_Monitor_type"),
				 CanopusPerformanceMonitoringPackage.Literals.MONITOR__IP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_sut_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_sut_feature", "_UI_Monitor_type"),
				 CanopusPerformanceMonitoringPackage.Literals.MONITOR__SUT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addHardwarePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Monitor_hardware_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Monitor_hardware_feature", "_UI_Monitor_type"),
				 CanopusPerformanceMonitoringPackage.Literals.MONITOR__HARDWARE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Monitor)object).getHostname();
