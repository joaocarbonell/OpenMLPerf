...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceMonitoring.canopusPerformanceMetric.Counter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Counter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Counter_name_feature", "_UI_Counter_type"),
				 CanopusPerformanceMetricPackage.Literals.COUNTER__NAME,
				 true,
				 false,
				 false,
