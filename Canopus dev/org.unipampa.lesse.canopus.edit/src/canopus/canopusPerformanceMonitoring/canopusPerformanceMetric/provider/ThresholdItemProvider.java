...
/**
 * This is the item provider adapter for a {@link canopus.canopusPerformanceMonitoring.canopusPerformanceMetric.Threshold} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThresholdItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Threshold_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Threshold_value_feature", "_UI_Threshold_type"),
				 CanopusPerformanceMetricPackage.Literals.THRESHOLD__VALUE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Threshold.class)) {
			case CanopusPerformanceMetricPackage.THRESHOLD__VALUE:
